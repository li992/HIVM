...
<a href="./About.php"><h1 id="secondbutton_header"    >About   </h1></a>
   <?php
               ...
               echo"<a href='./Medical_History'><h1 id='Medical_Historybutton_header'>Medical History </h1> </a>";
...
<!-- end top -->
<p id="Page_Sign">Make Apponitment</p>
...
$q1 = "SELECT distinct Specialty FROM UserInfo WHERE Specialty <> 'PATIENT'";
$r1 = $db->query($q1);
...
echo"<tr><td><h3 style='text-align: center;'>$Specialty</h3></td><td><input type='checkbox' value='$Specialty' class='Specialty'></td></tr>";
}
echo"</table></div>";
echo"</section>";
//specailty area end
...
echo"<span class='check_span'  style='text-align:center;'>Select Doctor</span>";
echo"<div class='Appointment_table'>";
echo"</div>";
echo"</section>";
//doctor area end
echo"</section>";
// left select area end (including specailty and doctor)
